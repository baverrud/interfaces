...
| `../../../common/axistream_pkg/rtl/payload_pkg.vhd` | Structured payload types + `to_slv`/`from_slv` pack/unpack |
| `../../../common/sync_fifo/rtl/sync_fifo.vhd` | Generic-width FWFT synchronous FIFO |
| `../../../common/stream_fifo/rtl/stream_fifo.vhd` | AXI-Stream wrapper around `sync_fifo` |
| `../../../common/pixel/rtl/pixel_producer.vhd` | RGB pixel stream source |
| `../../../common/pixel/rtl/pixel_consumer.vhd` | RGB pixel stream sink |
