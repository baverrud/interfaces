`timescale 1ns/1ps
// =====================================================================
// top_sub_slave_tb.sv - AXI3 full sub-channel demo self-checking TB
// =====================================================================
module top_sub_slave_tb;
  ...
  initial begin
    ...
    $display("=== AXI3 Full Sub-Channel Demo (%0d-beat bursts) ===", BURST_LEN);
    ...
    $display("=== AXI3 Full Sub-Channel Demo PASSED ===");
    $stop;
  end
endmodule
