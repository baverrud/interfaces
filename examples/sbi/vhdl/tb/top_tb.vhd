...
begin
  ...
  stim : process begin
    ...
    assert done = '1' report "SBI: timeout" severity failure;
    assert rd_data = x"000000A5" report "SBI: mismatch" severity failure;
    report "=== SBI PASSED ===" severity note; stop; wait;
  end process;
end architecture;
