-- =====================================================================
-- top_subtype_tb.vhd - testbench for the subtype-based pixel pipeline
-- =====================================================================
...
entity top_subtype_tb is
end entity;

architecture sim of top_subtype_tb is
...
begin
  ...
  -- DUT 1: pixel pipeline using the subtype-based top
  dut_pix : entity work.top_subtype
  ...
  begin
    ...
    report "=== PIPELINE (subtype / packed streams) PASSED ===" severity note;
