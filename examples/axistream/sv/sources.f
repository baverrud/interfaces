...
design  rtl/axis_32b_if.sv                     # concrete 32-bit AXI-Stream interface (example-specific)
...
design  rtl/top_concrete.sv                      # self-contained concrete 32-bit interface demo
design  rtl/top_array.sv                         # N parallel pixel lanes via interface arrays
sim     tb/top_tb.sv                             # self-checking TB (pack/unpack, IQ, pixel)
sim     tb/top_concrete_tb.sv                     # TB for the concrete interface demo
sim     tb/top_array_tb.sv                       # TB for the array-of-interfaces demo
